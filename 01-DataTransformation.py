...
for f in namelist:
    ...
    DATA_FILE = "../data/rawData/vynFixed/" + VYN_DATA
    ...
    #Calculate energy based on formulas from Kipp et al 2018
    ...
    #Calculate energy based on Peronnet original table

    original_peronnet_work = mod.oxygen_to_energy(VO2 =  work['VO2'], VCO2 =  work['VCO2'], diff_time = work_timediff)
    original_peronnet_rest = mod.oxygen_to_energy(VO2 =  resting_vyn['VO2'], VCO2 =  resting_vyn['VCO2'], diff_time = rest_timediff)
    ...
    original_peronnet_work_met_vyn = original_peronnet_work - ((original_peronnet_rest / rest_time ) * work_time)
    original_peronnet_work_met_per_rep = original_peronnet_work_met_vyn / 150 #number of leg extensions / flexions
    ...
    dict = {'MetabolicCalculation':["brockway", "wier", "peronnet", "original_peronnet"],
        'TotalMetabolicWork': [brock_work_met_vyn, wier_work_met_vyn, peronnet_work_met_vyn, original_peronnet_work_met_vyn],
        'MetabolicWorkPerRep':[brock_work_met_per_rep, wier_work_met_per_rep, peronnet_work_met_per_rep, original_peronnet_work_met_per_rep],
        'TotalMetabolicRest': [brock_rest_energy, wier_rest_energy, peronnet_rest_energy, original_peronnet_rest],
        'Resttime': [rest_time, rest_time, rest_time, rest_time],
        'Subject' : [Subject,Subject,Subject,Subject],
        'Contraction' : [Contraction_type,Contraction_type,Contraction_type,Contraction_type],
        'Load' : [Load,Load,Load,Load],
        'Ekstension_time': [eks_duration_rep, eks_duration_rep, eks_duration_rep,eks_duration_rep],
        'Flexion_time': [fleks_duration_rep, fleks_duration_rep, fleks_duration_rep,fleks_duration_rep],
        'Work': [work_sum, work_sum, work_sum, work_sum],
        'Watt': [watt, watt, watt, watt],
        'Bw': [id_info[3], id_info[3], id_info[3], id_info[3]]
    }
